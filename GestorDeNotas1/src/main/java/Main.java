        ...
        while (opcion != 8) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Inserta el nombre del alumno al que quieres modificar la nota: ");
                    nombre = scanner.nextLine();
                    System.out.println("Inserta la posición de la nota a modificar: ");
                    posicion = scanner.nextInt();
                    scanner.nextLine();
                    System.out.println("Inserta la nueva nota: ");
                    nota = scanner.nextFloat();
                    scanner.nextLine();
                    try {
                        System.out.println("Se ha modificado la nota " + miGestor.modificarNota(nombre, posicion, nota) + " por la nota " + nota);
                ...
                case 5:
                    System.out.println("Inserta el nombre del alumno al que quieres modificar la nota: ");
                    nombre = scanner.nextLine();
                    System.out.println("Inserta la posición de la nota a eliminar: ");
                    posicion = scanner.nextInt();
                    scanner.nextLine();
                    try {
                        System.out.println("Se ha eliminado la nota " + miGestor.eliminarNota(nombre, posicion));
                    } catch (IllegalArgumentException | ArrayIndexOutOfBoundsException e) {
                        System.err.println(e.getMessage());
                    }
                    break;
